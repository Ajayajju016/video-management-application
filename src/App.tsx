...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 duration-300 w-50" style={{width:"30%" ,marginLeft:"160px"}}>
  <iframe
